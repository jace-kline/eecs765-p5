...
The last parameters relevant to our attack are the locations of the shellcode and the ROP chain on the heap. The heap spray library we utilize allows us to deterministically know 
